...
class NF():
	...
	"""
        ...
        def __init__(self,kernel,sensor_kernel,obs_locns,Sigma_e,gamma_weight,Sigma_varepsilon,simulation_space_x_y,spacestep):

                self.kernel = kernel
                self.sensor_kernel=sensor_kernel
                self.obs_locns=obs_locns
                self.gamma_weight=gamma_weight
                self.Sigma_e=self.gamma_weight*Sigma_e            
