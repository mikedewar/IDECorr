...
In this paper, we take a different approach to estimate the spatial mixing kernel. Using the autocorrelation and cross-correlation of the observed field a simple method is proposed to estimate the spatial mixing kernel, filed disturbance characteristics and the observation noise variance. This eliminate the computational complexity of the methods proposed in \cite{Dewar2009,Scerri2009}. Alternatively the proposed method can be considered a prerequisite for the EM algorithm  where
