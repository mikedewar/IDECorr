...
\begin{figure*}[ht]
	...
	\caption{The effect of the observation noise on the spatial mixing kernel estimation. Cross-sections of the estimated spatial mixing kernel for different values of the observation noise variance are shown. The minimum defined by inequality \eqref{eq:BoundOnObsVariance} is $0.106$. }
	\label{fig:label}
\end{figure*}
